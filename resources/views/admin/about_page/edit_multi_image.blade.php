            ...
            <div class="card-body">
                ...
                <form action="{{route('update.multi.image')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <img id="showImage" src="{{asset($multiImage->multi_image)}}" alt="Mutltiple Image" class="rounded avatar-lg">
                        </div>
                    </div>
                    <!-- end row -->
                    <input class="btn btn-info waves-effect waves-light" type="submit" value="Update Image">
                </form>
